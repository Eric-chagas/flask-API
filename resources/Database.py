...
class DatabaseHandler:
    def __init__(self, filename="config.ini", section="postgresql", debug=False) -> None:
        ...
        self.databaseParameters = helperFunctions.getConfigParameters(section, filename, debug)

    def __del__(self) -> None:
        print("Deleting and closing connection")
